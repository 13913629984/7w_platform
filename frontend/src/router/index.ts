...
const routes: RouteRecordRaw[] = [
  { path: '/login', component: () => import('@/views/login/LoginView.vue') },
  {
    ...
    children: [
      ...
      { path: 'fin/receivables', component: () => import('@/views/fin/ReceivablesView.vue'), meta: { title: '应收管理', service: 'fin' } },
      { path: 'fin/payables', component: () => import('@/views/fin/PayablesView.vue'), meta: { title: '应付管理', service: 'fin' } },
